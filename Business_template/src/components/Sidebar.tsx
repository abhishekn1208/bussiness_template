...
const Sidebar: React.FC<SidebarProps> = ({ onSelectCategory, selectedCategory }) => {
  ...
  return (
    <div className="md:w-40 w-[85px] bg-gradient-to-b from-gray-400 via-gray-100 to-gray-100 top-0 sticky duration-300 rounded-md overflow-y-auto">
          ...
          return (
            <li
              ...
              className={`
                ...
                ${
                  isSelected
                    ? "scale-105 border-white/40 bg-white/20 backdrop-blur-xl shadow-[0_4px_20px_rgba(255,255,255,0.3)] text-gray-900"
